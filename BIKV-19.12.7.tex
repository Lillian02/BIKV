...
%When deleting a KV pair, KVell needs to get its location from the Btree, add the location in the slab’s free list and write a tombstone value in the slab to reclaim space and reuse these locations when new items are added.
